...
public class _MonitoringCentreStub
	...
	implements MonitoringSystem.MonitoringCentre
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = MonitoringSystem.MonitoringCentreOperations.class;
	public void raise_alarm(MonitoringSystem.NoxReading alarm_reading)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					MonitoringSystem.NoxReadingHelper.write(_os,alarm_reading);
					_is = _invoke(_os);
					return;
				}
		...
		else
		{
			...
			if( _so == null )
				continue;
			MonitoringCentreOperations _localServant = (MonitoringCentreOperations)_so.servant;
			try
			{
				_localServant.raise_alarm(alarm_reading);
...
_os.write_string( tmpResult8 );
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "register_agency", _opsClass );
			if( _so == null )
				continue;
			MonitoringCentreOperations _localServant = (MonitoringCentreOperations)_so.servant;
			try
			{
				_localServant.register_agency(who,contact_details,area_of_interest);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
