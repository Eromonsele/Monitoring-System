...
public class _MonitoringStationStub
	...
	implements MonitoringSystem.MonitoringStation
{
	/** Serial version UID. */
	...
	public java.lang.String station_name()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_station_name",true);
					_is = _invoke(_os);
					return _is.read_string();
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
			...
			else
			{
				...
				try
				{
					_result = _localServant.station_name();
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
						return _result;
				}
...
_os.write_string( tmpResult4 );
		...
		else
		{
			...
			try
			{
				_result = _localServant.activate(station_name,location,ior);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
	...
	public boolean is_active()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_is_active",true);
					_is = _invoke(_os);
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_get_is_active", _opsClass);
				if( _so == null )
					continue;
				MonitoringStationOperations _localServant = (MonitoringStationOperations)_so.servant;
				boolean _result;
